        ...
        <main>
            <div class="topbar">
                ...
                <div style="display:flex;gap:0.75rem;align-items:center;">
                    <div style="text-align:right;margin-right:0.75rem;"><div style="font-weight:700">Olá, Admin</div><div style="font-size:0.85rem;color:var(--muted)">salon@mybeauty.com</div></div>
